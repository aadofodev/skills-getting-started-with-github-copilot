...
activities = {
    ...
    "Soccer Team": {
        "description": "Team training and inter-school matches",
    ...
    "Debate Team": {
        "description": "Prepare for debates and public speaking tournaments",
...
def remove_participant(activity_name: str, email: str):
    """Unregister a student from an activity. `email` is provided as a query parameter."""
    # Validate activity exists
    if activity_name not in activities:
        raise HTTPException(status_code=404, detail="Activity not found")
